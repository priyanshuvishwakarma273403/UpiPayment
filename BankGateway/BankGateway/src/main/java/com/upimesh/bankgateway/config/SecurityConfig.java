package com.upimesh.bankgateway.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Actuator endpoints — open for health probes
                        .requestMatchers("/actuator/health", "/actuator/info", "/actuator/metrics", "/actuator/circuitbreakers").permitAll()
                        // All bank gateway endpoints require internal service header
    ...
    public static class InternalServiceKeyFilter extends OncePerRequestFilter {
        ...
        protected void doFilterInternal(HttpServletRequest request,
            ...
            if (serviceKey == null || !serviceKey.equals(expectedKey)) {
                log.warn("Unauthorized request to bank-gateway service | path={} | ip={}",
            ...
            log.info("Bank Gateway request | method={} | path={} | ip={}",
