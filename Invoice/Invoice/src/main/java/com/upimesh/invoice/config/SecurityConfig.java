package com.upimesh.invoice.config;
...
public class SecurityConfig {
    ...
    @Value("${invoice.internal-key:internal-secret-change-in-prod}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // PDF download should be authenticated if needed, but since it's internal we authenticate all endpoints
