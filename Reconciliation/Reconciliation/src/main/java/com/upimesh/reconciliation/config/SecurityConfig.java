package com.upimesh.reconciliation.config;
    ...
    public static class InternalServiceKeyFilter extends OncePerRequestFilter {
        ...
        protected void doFilterInternal(HttpServletRequest request,
            ...
            if (serviceKey == null || !serviceKey.equals(expectedKey)) {
                log.warn("Unauthorized request to reconciliation service | path={} | ip={}",
            ...
            log.info("Reconciliation request | method={} | path={} | ip={}",
