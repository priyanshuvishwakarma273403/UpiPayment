package com.upimesh.settlement.util;
...
@UtilityClass
@Slf4j
public class SettlementEncryptionUtil {
    ...
    private static SecretKey generateDevKey() {
        try {
            ...
            log.warn("⚠️ Using generated AES-256 key for SettlementEncryptionUtil. Use KMS/Vault in production!");
